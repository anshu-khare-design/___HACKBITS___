package com.example.myapplication.GraphicUtils;
 ...
 *  Graphic#translateX(float)}  Graphic#translateY(float)} adjust the
...
public class GraphicOverlay extends View {
     ...
     * this and implement the method to define the graphics element. Add
     * instances to the overlay using
     */
    public abstract static class Graphic {
         ...
         * Graphic#scaleX(float)}  Graphic#scaleY(float)} adjust the size of the
         * supplied value from the preview scale to the view scale.
         *  Graphic#translateX(float)}  Graphic#translateY(float)} adjust the
         * coordinate from the preview's coordinate system to the view coordinate system.
         *
